...
1. Clone the repository:
   ```bash
   git clone https://github.com/yourusername/anxiety-rls-detection.git
   cd anxiety-rls-detection
   ```
...
├── src/                    # Scripts (preprocessing, feature extraction, model training)
├── README.md               # Project overview
├── requirements.txt        # Required Python packages
└── references/             # Related papers & articles
```
